...
# 變更環境路徑
os.chdir('/content/drive/MyDrive/Colab Notebooks/AOI/aoi')
...
# img_shape should be set according to the input limit of the model (Densenet)
img_shape = (224,224)
batch_size = 16
...
test_list.to_csv('/content/drive/MyDrive/Colab Notebooks/AOI/aoi/densenet_submit.csv',index=False)
...
model.save('/content/drive/My Drive/Colab Notebooks/AOI/aoi/densenet.h5')
# model= load_model('/content/drive/MyDrive/Colab Notebooks/AOI/aoi/densenet.h5')
